...
public:
	...
	{
		intensity = 100;
	//	position = glm::vec3(10,15,10);
	//	position = glm::vec3(0, 0,10);
	  position = glm::vec3(-5, 4, 6);
	//	position = glm::vec3(0,7,5);
	//	position = glm::vec3(0, 5, 2);
	//	position = glm::vec3(0, 8, 0);
	}
...
class ofApp : public ofBaseApp{
	...
	public:
		...
		ofColor LambertPhong(Ray ray, const glm::vec3& p, const glm::vec3& norm, const ofColor diffuse, const ofColor specular, float power);
		bool inShadow(Ray ray,glm::vec3& p,glm::vec3& norm);
		void applyText(ofImage texture);
		ofColor getColor(glm::vec3 vec);
		float IJConversion(float uv, float size);

		glm::vec3 p = glm::vec3 (0, -1, 0);
		glm::vec3 n = glm::vec3(0, 1, 0);
		ofColor diffuse = ofColor::gray;
		float w = 100;
		float h = 100;
		...
		Plane * plane = new Plane(p, n, diffuse,20,20);
		...
		glm::vec3 holdConverted;
		glm::vec3 intersectPoint;
		glm::vec3 normal;
		glm::vec3 pointOfInterection;
	
		glm::vec3 spherevec = glm::vec3(-2, 0, -3);
		glm::vec3 spherevec2 = glm::vec3(0, 0, 0);
		glm::vec3 spherevec3 = glm::vec3(1, 0, -2);

		float radius = 1.0;

		Sphere * sphere = new Sphere(spherevec, radius,blue);
		Sphere * sphere2 = new Sphere(spherevec2, radius,red);
		Sphere * sphere3 = new Sphere(spherevec3, radius,yellow);
	...
	//	int imageHeight = 400;
		...
		Light* light2 = new PointLight(glm::vec3(17, 4, 6),100);
		...
		ofColor finalColor;
		glm::vec3 blockedIntersect;
		glm::vec3 blockedNormal;
		glm::vec3 shadowRay;
